                            ...
                            <table class="table" >
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="gender">
                                            <option value="{{$att->gender}}" selected="selected">{{$att->gender}}</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="hrange">
                                            <option value="{{$pro->hrange}}" selected="selected" >{{$pro->hrange}}个月</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="rate">
                                            <option value="{{$pro->rate}}" selected="selected">{{$pro->rate}}%</option>
