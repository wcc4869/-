...
<div class="index_main w1180 front">
    <div class="login_front">
        ...
        <p class="fs_24 bold m">注册送10000元体验金</p>
         <span id="static_banner_login"><a title="免费注册" rel="nofollow" href="auth/register" class="btn_orange">免费注册</a>
             <a title="马上登录" rel="nofollow" class="orange" href="auth/login">马上登录</a></span>
    </div>
</div>
@endif
    ...
    <div class="clearfix fl fluid index_left">
            ...
            <div class="clearfix mb_20 module pro_list holidy_main_no3">
                ...
                <div class="fl pro_img list_img3">
                    ...
                    <div class="btn_box"><a target="_blank" href="{{url('more')}}">查看更多</a></div>
                </div>
                <!--l e-->
                <!--r s-->
                    ...
                    <div class="pro_bor">
                        <ul class="clearfix pro_list_box">
                            ...
                            <li class="w3">
                                ...
                                <p class="fc_6 airal fs_18">{{$p->recive}}</p>
                            </li>
                            <li class="w4">
                                <span class="b_jingdu b_jd86{{sprintf('%d',100*$p->recive/$p->money)}}">{{sprintf('%.2f',100*$p->recive/$p->money)}}%</span>
                            </li>
                            <li class="w5">
                                    <a class="btn btnSize_1 btn_orange" href="{{url('pro',['pid'=>$p->pid])}}">立即投标</a>
                            </li>
                        </ul>
                    </div>
                    @endforeach
