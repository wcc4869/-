...
<div class="crumbs userCrumbs">
    <a class="first" href="#">账户中心</a><span>&gt;</span><a class="two" href="#">借款管理</a><span>&gt;</span><a class="two">项目列表</a>
</div>
<!--面包屑 end-->
<!--layout start-->
    ...
    <div class="clearfix main_wrapper">
    	<div class="container">
            <div class="accountCenter">
                <span class="fs_18 left">我的项目列表</span>
                            ...
                            <table class="table">
                                ...
                                @forelse($mypro as $p)
                                    <tr>
                                        ...
                                        <td class="l"><a href="{{url('edit',['pid'=>$p->pid])}}">编辑</a>
                                        <a href="{{url('delete',['pid'=>$p->pid])}}">删除</a></td>
                                    </tr>
                                @empty
