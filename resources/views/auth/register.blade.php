...
<!--main-->
		...
		<div class="clearfix simpleHead01">
			<div class="fl">
		    	<a href="{{url('/')}}"><img height="52" style="vertical-align: initial;" alt="点点贷" src="/image//logo_all.png"></a><span>注册</span>
		    </div>
			...
			<div class="nwd_loginPos">
				...
				<div class="clearfix nwd_loginOut">
                    ...
                    <div class="content_box pb_20">
						...
						{{--<label class="input_text yzm3"><i class="fr yzm_img"><img width="80" height="32" src="captcha/0" id="imgc"></i>--}}
							{{--<a onclick="javascript:re_captcha();" ><input type="text" class="inp_bor inpIco5" placeholder="验证码" id="imgcode" name="imgcode"></a>--}}
						{{--</label>--}}
